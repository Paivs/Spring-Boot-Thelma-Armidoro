...
@Table(name = "acessosenha")
@Entity(name = "AcessoSenha")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class AcessoSenha {
    ...
    public AcessoSenha(DadosCadastroAcessoSenha dados) {
    ...
    public void enviarPinSenha(EmailService emailService){
        emailService.pinMudarSenha(this.login, this.pin);
    }
